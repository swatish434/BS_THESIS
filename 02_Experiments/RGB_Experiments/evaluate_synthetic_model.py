#!/usr/bin/env python3
"""
Evaluate trained model with per-class metrics.
"""
import sys
import os
...
def main():
    model_path = "Results/deeplabv3_real_synthetic_best.pth"
    ...
    # Save results
    results_file = "Results/synthetic_model_evaluation.txt"
    with open(results_file, 'w') as f:
        f.write("=== DeepLabv3+ (Real + Synthetic) Evaluation ===\n\n")
